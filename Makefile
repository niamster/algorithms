...
sort: sort.c qsort.c hsort.c msort.c ssort.c $(HELPERS)
...
test-ssort: sort
	...
	$(Q)echo "ssort-1"
	$(Q)./sort -s SS1 -i $(OUT_DIR)/$@.$(TST_RND_CNT).rnd $(RFLAGS)
	$(Q)echo "==========================================="
	$(Q)echo "ssort-2"
	$(Q)./sort -s SS2 -i $(OUT_DIR)/$@.$(TST_RND_CNT).rnd $(RFLAGS)
	$(Q)echo "==========================================="
	$(Q)echo "ssort-3"
	$(Q)./sort -s SS3 -i $(OUT_DIR)/$@.$(TST_RND_CNT).rnd $(RFLAGS)
	$(Q)echo "==========================================="
